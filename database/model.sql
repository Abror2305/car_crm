...
create table users(
    user_id int generated always as indetity primary key,
...
create table branches(
    branch_id int generated always as indetity primary key,
...
create table transports(
    transport_id int generated always as indetity primary key,
...
create table permissions(
    permission_id int generated always as indetity primary key,
    permission_name character varying(8)
)

drop table if exists user_permissions cascade;
create table user_permissions(
    up_id int generated always as indetity primary key,
